...
M_quantile <- as.integer(quantile(M_sal$salary,
  ...
  round(0)#%>%
  #format(scientific = FALSE)
#When I convert the quantile data frame to have its outputs not be in scientific notation the following objects throw an error: 
...
What is the difference in salary between men and women at the median? 
  ...
  * Median salary for women is $`r F_quantile[6]`
  * Median salary for men is $`r M_quantile[6]`
